...
class RkPager3_itemsPerPage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return (
      <aside className="jspager3_perpageholder">
      <label for="jspager3_perpage">perPage:&nbsp;</label>
      <select name="jspager3_perpage" className="jspager3_perpage" 
...
class RkPager3_btnFirst extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
class RkPager3_btnPrev extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
class RkPager3_btnNext extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
class RkPager3_btnLast extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
class RkPager3_pageBtnItems extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    if (this.props.pr_i === "...") {
      return (
          <a className="jspager3_pagebtn_dots" tabindex="0">
            {this.props.pr_i}
          </a>
        );
    } else if (this.props.pr_i === this.props.pr_currentPage) {
      return (
          <a className="jspager3_pagebtn 
          jspager3_pagebtn--active" tabindex="0" 
      ...
      return (
       <a className="jspager3_pagebtn" tabindex="0" 
       onClick={() => { this.props.pr_val_showItems(this.props.pr_i) }}>
            {this.props.pr_i}
        </a>
      );
...
class RkPager3_pageBtns extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
class RkPager3_pageSelector extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return (
      <aside className="jspager3_totalpagesholder">
      <label for="jspager3_select">Page:</label>
      <p>{this.props.pr_currentPage}</p>
      <select className="jspager3_select" 
...
class RkPager3_itemList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return (
      <div className="row jspager3_items" 
...
export default class RkPager3 extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div className="jspager3_holder">

      <RkPager3_itemList 
      pr_list={this.state.itemList} />

      <nav className="jspager3">
      
      <aside className="jspager3_prevnextholder">
        <RkPager3_btnFirst 
